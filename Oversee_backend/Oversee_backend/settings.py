"""
Django settings for Oversee_backend project.
...
SECRET_KEY = 'django-insecure-v%)abao^z56h*nw(rm9^#6txe5=_%qie+p8jutuk5xg84633v9'
...
MIDDLEWARE = [
    ...
    # 'login.middleware.InternalNavMiddleware',
]

ROOT_URLCONF = 'Oversee_backend.urls'
...
WSGI_APPLICATION = 'Oversee_backend.wsgi.application'
